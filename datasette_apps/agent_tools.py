...
APP_TOOL_DESCRIPTIONS = {
    ...
    "debug": (
        ...
        "the app's global scope once the page has parsed and its own scripts "
        "have run; its awaited return value is the result and "
        ...
        "calls, from page load through script completion. Some browsers "
        "report errors against app-script-N - the app's Nth <script> "
        "element - with line numbers within that script and the failing "
        "line as sourceLine. Caveat: synthetic "
