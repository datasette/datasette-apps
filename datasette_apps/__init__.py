...
def register_routes():
    return [
        ...
        (r"^/-/apps/debug/(?P<job_id>[^/]+)/claim$", debug_claim),
        (r"^/-/apps/debug/(?P<job_id>[^/]+)/frame$", debug_frame),
        (r"^/-/apps/debug/(?P<job_id>[^/]+)/query$", debug_query),
        (r"^/-/apps/debug/(?P<job_id>[^/]+)/result$", debug_result),
